...
exports.WebPosEntitlementService = void 0;
 ...
 */
class WebPosEntitlementService {
    static async getEntitlement(merchantId) {
        ...
        if (merchant.resellerId) {
            const row = await db.query.resellers.findFirst({
                where: (0, drizzle_orm_1.eq)(db_1.schema.resellers.id, merchant.resellerId),
    ...
    static async assertAllowed(merchantId) {
    ...
    static async guard(merchantId, res) {
        if (!merchantId) {
...
exports.WebPosEntitlementService = WebPosEntitlementService;
//# sourceMappingURL=webpos-entitlement.service.js.map