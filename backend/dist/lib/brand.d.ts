...
export declare const LEGACY_HOST_ALIASES: string[];
export declare const CURRENT_HOST_ALIASES: string[];
export declare function rewriteLegacyPublicHost(value: string): string;
