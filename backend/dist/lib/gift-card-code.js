...
exports.extractGiftCardCode = extractGiftCardCode;
exports.normalizeScannedPayload = normalizeScannedPayload;
exports.parseGiftCardCode = parseGiftCardCode;
exports.buildGiftCardRedeemQrPayload = buildGiftCardRedeemQrPayload;
exports.buildGiftCardBarcodePayload = buildGiftCardBarcodePayload;
exports.ecardLookupCandidates = ecardLookupCandidates;
exports.generateEcardCode = generateEcardCode;
exports.buildGiftCardRedeemUrl = buildGiftCardRedeemUrl;
 ...
 */
function extractGiftCardCode(raw) {
...
function ecardLookupCandidates(raw) {
...
function generateEcardCode() {
    return `EC-${crypto_1.default.randomBytes(4).toString("hex").toUpperCase()}`;
}
/** Optional public deep link shown in emails (not used on thermal QR/barcode). */
function buildGiftCardRedeemUrl(code) {
...
//# sourceMappingURL=gift-card-code.js.map