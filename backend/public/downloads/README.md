...
curl -sL https://app.rebornsense.com/downloads/chaslayreborn-print-agent-setup.exe | head -c 2 | xxd
# 00000000: 4d5a  MZ
```
...
- `https://api.rebornsense.com/downloads/chaslayreborn-print-agent-setup.exe`
