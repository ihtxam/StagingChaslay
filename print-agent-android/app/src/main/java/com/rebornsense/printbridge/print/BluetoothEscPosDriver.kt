...
class BluetoothEscPosDriver : PrinterDriver {
    ...
    /**
     * Pace SPP writes like Windows print-agent so kitchen tickets are not truncated.
     * Strips embedded cut suffix, trims trailing feeds, appends one btCutTrailer, and
     * sends body+cut in a single paced stream — avoids visible 2–3 phase jerks on clones.
     */
