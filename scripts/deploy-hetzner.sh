...
PRINT_HDR="$(curl -sI https://app.chaslay.com/downloads/chaslayreborn-print-agent-setup.exe || true)"
...
PRINT_MAGIC="$(curl -sL https://app.chaslay.com/downloads/chaslayreborn-print-agent-setup.exe | head -c 2 | od -An -tx1 | tr -d ' \n' || true)"
