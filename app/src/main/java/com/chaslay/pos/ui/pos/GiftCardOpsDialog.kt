...
fun GiftCardOpsDialog(
    ...
    onAddToCart: (amount: Double, cardNumber: String, cardId: String?, holderName: String?) -> Unit
) {
    ...
    AlertDialog(
        ...
        text = {
            Column(modifier = Modifier.fillMaxWidth()) {
                Text(
                    when (mode) {
                        GiftCardOp.SELL -> stringResource(R.string.gift_card_sell_hint)
                        GiftCardOp.RELOAD -> stringResource(R.string.gift_card_reload_hint)
                    },
        ...
        confirmButton = {
            Button(
                ...
                enabled = !busy &&
                    resolvedAmount != null &&
                    when (mode) {
                        GiftCardOp.SELL -> code.trim().isNotEmpty()
                        GiftCardOp.RELOAD -> lookedUpCard != null
                    }
            ) {
