...
export const PANEL_NAV_HIDE_OPTIONS: Array<{ key: string; labelKey: string }> = [
  { key: 'cms', labelKey: 'panelNavHideCms' },
  { key: 'customers', labelKey: 'panelNavHideCustomers' },
  ...
  { key: 'platform-shop', labelKey: 'panelNavHidePlatformShop' },
];
