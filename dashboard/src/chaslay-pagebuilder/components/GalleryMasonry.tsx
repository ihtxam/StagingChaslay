...
export const GalleryMasonry: React.FC<GalleryProps> & {
  craft: {
    props: GalleryProps;
  ...
  return (
    ...
    >
      ...
      <div
        className="hb-gallery-masonry"
        style={{
          columnCount: mergedProps.columns,
          columnGap: `${mergedProps.gap}px`,
          maxWidth: '1100px',
          margin: '0 auto',
        }}
      >
        {displayImages.map((src, i) => (
          <div
            ...
            style={{
              breakInside: 'avoid',
              marginBottom: `${mergedProps.gap}px`,
...
const GalleryMasonrySettings: React.FC = () => {
...
GalleryMasonry.craft = {
  props: defaultProps,
  related: { settings: GalleryMasonrySettings },
