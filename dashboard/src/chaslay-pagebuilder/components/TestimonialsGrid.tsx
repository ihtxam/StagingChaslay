...
export const TestimonialsGrid: React.FC<TestimonialsProps> & {
  craft: {
...
const TestimonialsGridSettings: React.FC = () => {
          ...
          {(p.testimonials || []).map((t: TestimonialItem, i: number) => (
            <div key={i} className="border rounded-lg p-3 space-y-2 bg-muted/30">
              ...
              <div className="space-y-1">
                ...
                <Input
                  value={t.photo || ''}
                  onChange={(e) => setProp((props: TestimonialsProps) => { if (props.testimonials) props.testimonials[i].photo = e.target.value; })}
...
TestimonialsGrid.craft = {
  props: defaultProps,
  related: { settings: TestimonialsGridSettings },
