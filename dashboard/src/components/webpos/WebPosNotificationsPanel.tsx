...
export default function WebPosNotificationsPanel({
  ...
  return (
    <div className="absolute right-0 top-[calc(100%+6px)] z-[55] flex max-h-[min(70vh,28rem)] w-[min(22rem,calc(100vw-1.5rem))] flex-col overflow-hidden rounded-xl border border-stone-200 bg-white shadow-xl">
