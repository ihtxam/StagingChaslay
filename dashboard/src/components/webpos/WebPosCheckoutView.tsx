...
export default function WebPosCheckoutView({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden bg-white lg:flex-row">
      ...
      */}
      <div className="webpos-checkout-scroll flex min-h-0 flex-1 flex-col overflow-y-auto overscroll-y-contain [-webkit-overflow-scrolling:touch] lg:contents">
        ...
        {/* Left: payment methods + compact actions + keypad */}
        <div className="order-2 flex shrink-0 flex-col gap-2 border-b border-stone-100 p-3 lg:order-1 lg:h-full lg:w-[min(20rem,36vw)] lg:overflow-y-auto lg:border-b-0 lg:border-r">
          ...
          {/* One compact icon row: customer / split / discount / tip / drawer */}
        ...
        <div className="order-3 flex min-h-0 flex-1 flex-col lg:order-2 lg:h-full lg:overflow-hidden">
          <div className="flex min-h-0 flex-1 flex-col items-center px-4 py-3 text-center lg:overflow-y-auto lg:py-8">
          ...
          <div className="webpos-checkout-footer mt-auto flex shrink-0 items-stretch gap-2 border-t border-stone-100 bg-white p-3 sm:p-4">
            {onBack ? (
              <button
                type="button"
                disabled={busy}
